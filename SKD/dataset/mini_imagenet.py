...
class MetaImageNet(ImageNet):
    ...
    def __getitem__(self, item):
        ...
        # support_xs=Image.fromarray(support_xs)
        # query_xs = Image.fromarray(query_xs)
        # for idx,i in enumerate(support_xs):
        #     support_xs[idx]=Image.fromarray(i)
        # for idx,i in enumerate(query_xs):
        #     query_xs[idx]=Image.fromarray(i)
